...
const DialogWait = extend(FlexLayout)(
	...
	function(_super, props) {
		...
		const lblSavingStyle = getCombinedStyle(".label", {
			textAlignment: TextAlignment.TOPCENTER,
			width: 245,
			height: 54,
			marginBottom: null,
			text: "Saving New Customer",
			multiline: true,
			flexGrow: null,
			font: Font.create("Lato", 22, Font.NORMAL)
		});  
		var lblSaving = new Label(lblSavingStyle);  
		if(lblSavingStyle.scrollEnabled === false)
			lblSaving.ios && (lblSaving.ios.scrollEnabled = false);
		flWaitWhite.addChild(lblSaving);
		this.lblSaving = lblSaving;
